...
router.get("/", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                redisStorage = _a.sent();
                return [4 /*yield*/, redis.setRedisStorageClient(payload)];
            case 2:
                _a.sent();
                //set whatsapp Number
                commonUtils.sendTo = commonUtils.convertToTwilioNumber(payload.msisdn);
                commonUtils.message = payload.message;
                return [4 /*yield*/, commonUtils.sendTwilioWhatsappMessage()];
            case 3:
                _a.sent();
                res.send("done");
                return [3 /*break*/, 5];
