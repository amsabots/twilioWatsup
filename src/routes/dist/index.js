...
router.post("/api/twilio/", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_d) {
        switch (_d.label) {
            ...
            case 1:
                redisRecord = _d.sent();
                if (!(NumMedia == 0)) return [3 /*break*/, 12];
            ...
            case 6:
                ...
                _d.label = 7;
            case 7: return [4 /*yield*/, utils.sendTwilioMediaMesssage(data.imageUrl)];
            case 8:
                _d.sent();
                _d.label = 9;
            case 9: return [4 /*yield*/, redis.setRedisStorageClient(data)];
            case 10:
                _d.sent();
